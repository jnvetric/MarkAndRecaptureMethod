...
public class PeopleRank implements RoutingDecisionEngine, CommunityDetectionEngine {
    ...
    protected Map<DTNHost, List<Friend>> peopleRank;
    protected Map<DTNHost, Tuple<Double, Integer>> pRank; 
    protected Double d = 0.5;
    protected Set<DTNHost> f;
    ...
    public PeopleRank(PeopleRank proto) {
        ...
        pRank = new HashMap<DTNHost, Tuple<Double, Integer>>();
    }
...
//    protected double countRank(DTNHost h){
//        
//        
//    }
