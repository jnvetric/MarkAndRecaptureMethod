...
public abstract class ActiveRouter extends MessageRouter {
     ...
     * {@link MessageRouterKu#receiveMessage(Message, DTNHost)}, i.e.
     * {@link MessageRouterKu#RCV_OK} if receiving seems to be OK,
     * TRY_LATER_BUSY if router is transferring, DENIED_OLD if the router is
     * already carrying the message or it has been delivered to this router (as
     * final recipient), or DENIED_NO_SPACE if the message does not fit into
     * buffer
     */
...
//        return true;
        ...
        while (freeBuffer < size) {
            List<Message> m
                    = new ArrayList<Message>(this.getMessageCollection());
            this.sortByQueueMode(m);

            Message msg = m.get(m.size() - 1);
            ...
            System.out.print("Pesan : " + msg.toString() + ", ");
            System.out.print("Hop Count : " + msg.getHopCount() + "\n");
        }
     ...
     * {@link MessageRouterKu#sortByQueueMode(List)}. See
...
//                connections1 = connections.toArray(connections1);
        ...
        // untuk print pesan
        for (Message m : messages) {
            System.out.print("Pesan : " + m.toString() + ", ");
            System.out.print("Hop Count : " + m.getHopCount() + "\n");
        }
        System.out.print("\n");
